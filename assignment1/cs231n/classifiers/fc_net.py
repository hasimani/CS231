...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        pre_hidden = np.dot(x,self.params['W1']) + self.params['b1']
        hidden_layer = np.maximum(0,pre_hidden)
        ...
        probs = exp_scores / scores_sums
        cors = probs[range(num_train), y]
        data_loss = -np.sum(np.log(cors))/num_train
